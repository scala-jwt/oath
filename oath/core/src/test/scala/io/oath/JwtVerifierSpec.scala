    ...
    "verifyJwt TokenH" should {
      ...
      "fail to decode a token with header" in {
        ...
        verified shouldBe Left(
          JwtVerifyError.DecodingError("DecodingFailure at .mapping: Missing required field", null)
        )
      }
